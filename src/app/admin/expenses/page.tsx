...
import { ArrowLeft, Search, Eye, Download, DollarSign, CheckCircle, X, AlertCircle } from 'lucide-react';
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">{expenses.filter(e => e.status === 'approved').length}</p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-gray-900">${expenses.reduce((sum, e) => sum + e.amount, 0).toFixed(2)}</p>
                </div>
